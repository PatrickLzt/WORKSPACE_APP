                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="w-full ">
                                ...
                                <Input id="workspaceName" type="text" placeholder="Workspace Name" disabled={isLoading} {...register('workspaceName', {
                        ...
                        <div>
                            ...
                            <Input id="logo" type="file" accept="image/*" placeholder="Workspace Name" {...register('logo', {
                                required: false,
                            })} />
                            <small className="text-red-600">
