...
const SettingsForm = () => {
    ...
    const workspaceNameChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        titleTimerRef.current = setTimeout(async () => { }, 500);
    };
    ...
    useEffect(() => {
        const showingWorkspace = state.workspaces.find((workspace: any) => workspace.id === workspaceId);
    ...
    return (
        <div className="flex gap-4 flex-col">
            ...
            <>
                ...
                {permissions === 'shared' && (
                    <div>
                        <CollaboratorSearch existingCollaborators={collaborators} getCollaborator={(user: any) => {
