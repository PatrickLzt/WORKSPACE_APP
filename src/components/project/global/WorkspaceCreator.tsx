/**
 * @file src/components/global/WorkspaceCreator.tsx
    ...
    return (
        <div className="flex gap-4 flex-col">
            ...
            <>
                ...
                <Select onValueChange={(val: any) => { setPermissions(val); }}
            ...
            <Button type="button" disabled={!title || (permissions === 'shared' && collaborators.length === 0) || isLoading} variant={'secondary'} onClick={createItem}>
                Create
            </Button>
        </div>
    );
